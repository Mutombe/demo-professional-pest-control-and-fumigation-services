...
/* ================================================================
   ...
   ================================================================ */
const iconMap = {
  Leaf, Star, Buildings, Lightbulb, Shield, HardHat,
};
    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {['YOUR SPACE', 'PEST-FREE', 'GUARANTEED.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
...
function MarqueeTicker() {
  const items = ['PEST CONTROL', 'FUMIGATION', 'TERMITE TREATMENT', 'RODENT CONTROL', 'SANITIZATION', 'INSPECTIONS'];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  src={hero.backgroundImages?.[0]?.url || 'https://images.unsplash.com/photo-1584813539890-30373c796e72?w=800&q=80'}
    ...
    <section ref={ref} className="bg-navy-900 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <img
              src={siteData.hero.backgroundImages?.[0]?.url || 'https://images.unsplash.com/photo-1584813539890-30373c796e72?w=800&q=80'}
